...
public class ConferenceApi {
    ...
    public Profile saveProfile(User user, ProfileForm profileForm) throws UnauthorizedException {
        ...
        if (user == null) throw new UnauthorizedException("UnauthorizedException");
        // TODO 1
    ...
    public List<Conference> getConferencesCreated(User user) throws Exception {
        if (user == null) throw new Exception("Log in required for this operation");
                ...
                try {
                    ...
                    if (profile.getConferenceKeysToAttend().contains(
                        ...
                        queue.add(ofy().getTransaction(),
                                TaskOptions.Builder.withUrl("/tasks/send_confirmation_email").param("email", profile.getMainEmail()).param("conferenceInfo", conference.toString()));
                        // We are booked!
    ...
    public Collection<Conference> getConferencesToAttend(final User user)
        ...
        for (String key : keyStringsToAttend) {
            Key<Conference> conference = Key.create(key);
            collection.add(ofy().load().key(conference).now());
        }
        // TODO
    ...
    public Announcement getAnnouncements() {
        ...
        if (announcement != null)
            return new Announcement(announcement.toString());
        else return null;
    }
}
